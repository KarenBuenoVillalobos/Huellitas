let header = '<a href="index.html" class="logo"><img id="logo" src="img/logo.png" alt="huellitas-de-amor"></a><input type="checkbox" id="check"><label for="check" class="mostrar-menu">&#8801</label><nav class="menu"><a href="index.html">Home</a><a href="nosotros.html">Nosotros</a><a href="adopta.html">Adopta</a><a href="listado.html">Listado</a><a href="contacto.html">Contacto</a><a href="donar.html">Donar</a><label for="check" class="esconder-menu">&#215</label></nav>';
