let header = '<a href="/" class="logo"><img id="logo" src="/img/logo.png" alt="huellitas-de-amor"></a><input type="checkbox" id="check"><label for="check" class="mostrar-menu">&#8801</label><nav class="menu"><a href="/">Home</a><a href="/nosotros">Nosotros</a><a href="/adopta">Adopta</a><a href="/contacto">Contacto</a><a href="/donar">Donar</a><a href="/loginsesion">Iniciar Sesión</a><a href="/admin" id="admin-link">Lista</a><label for="check" class="esconder-menu">&#215</label></nav>';
